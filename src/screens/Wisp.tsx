...
const WISP_CAPTION: Record<WispColor, string> = {
  ...
  'violet-green': 'a moth-pale green threaded through it — Cael was here',
  'violet-ink': 'deep ink-blue at the edges — Petra would have sorted it this way',
...
const FLASH_COLOR: Record<WispColor, string> = {
  ...
  'violet-green': 'bg-primary/25',
  'violet-ink': 'bg-tertiary/30',
